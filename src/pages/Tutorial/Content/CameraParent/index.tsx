...
const onSceneReady = (scene: Scene) => {
  ...
  const camera = new ArcRotateCamera("camera", 0, 0, -Math.PI, new Vector3(-Math.PI / 2, 6, 0), scene);
  // camera.upperBetaLimit = Math.PI / 22.2;
...
export default CameraParentScene;
